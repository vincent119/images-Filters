...
產生 commit message 時，必須完整遵循以下格式與規則。
...
- 模組名稱：`auth`、`user`、`payment`、`ec2`
- 技術元件：`logging`、`api`、`db`、`excel`
...
docs(readme): 更新編譯說明與專案結構
config(excel): 新增語言設定選項
```
